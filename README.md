...
хвост со встроенными Hrust-ассетами в одну DSS-страницу и сразу закрывает EXE.
После завершения сетевого обмена ассеты распаковываются в пять DSS-страниц;
дальнейшая перерисовка не зависит от диска. Для неё рядом с EXE нужны
`AFNT320.DLL` и `GFX320.DLL`.
